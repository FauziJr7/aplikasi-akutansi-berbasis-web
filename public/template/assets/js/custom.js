...
function BarisBaru() {
    ...
    var Baris = '<tr>';
        ...
        // Baris += '<input class="form-control" name="kode_akun3[]" id="kode_akun3'+ Nomor +'" required> </input>';
        Baris += '</td>';
        Baris += '<td>';
        ...
        // Baris += '<input class="form-control" name="id_status[]" id="id_status'+ Nomor +'" required> </input>';
        Baris += '</td>';
