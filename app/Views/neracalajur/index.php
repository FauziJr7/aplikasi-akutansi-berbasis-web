...
<title>SIA-Fauzi &mdash; Neraca Lajur</title>
<?= $this->endSection() ?>
            ...
            <form action="<?= site_url('neracalajur') ?>" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col">
                        ...
                        <input type="submit" class="btn btn-success" formtarget="_blank" formaction="neracalajur/neracalajurpdf" value="Cetak EXCEL">
                    </div>
                </div>
            </form>
        </div>
