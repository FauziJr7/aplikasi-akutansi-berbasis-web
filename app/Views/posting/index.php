...
<title>SIA-Fauzi &mdash; Posting</title>
<?= $this->endSection() ?>
            ...
            <form action="<?= site_url('posting') ?>" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <input type="submit" class="btn btn-danger" formtarget="_blank" formaction="posting/postingpdf" value="Cetak PDF">
                        <input type="submit" class="btn btn-success" formtarget="_blank" formaction="posting/postingexcel" value="Cetak EXCEL">
                    </div>
                </div>
            </form>
        </div>
