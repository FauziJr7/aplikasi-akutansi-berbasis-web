...
<li class="#"><a class="nav-link" href="<?= site_url('jurnalumum') ?>"><i class="fas fa-columns"></i> <span>Jurnal Umum</span></a></li>
<li class="#"><a class="nav-link" href="<?= site_url('posting') ?>"><i class="fas fa-th"></i> <span>Posting</span></a></li>
<li class="#"><a class="nav-link" href="<?= site_url('neracasaldo') ?>"><i class="fas fa-columns"></i> <span>Neraca Saldo</span></a></li>
<li class="#"><a class="nav-link" href="<?= site_url('neracalajur') ?>"><i class="fas fa-th"></i> <span>Neraca Lajur</span></a></li>
...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu">
        ...
        <li><a class="nav-link" href="<?= site_url('perubahanmodal') ?>">Perubahan Modal</a></li>
